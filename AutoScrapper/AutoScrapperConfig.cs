    ...
    public class AutoScrapperConfig
    {
        ...
        private void SetupConfig()
        {
            ...
            if (RiskOfOptionsCompatibility.Enabled)
            {
                ...
                RiskOfOptionsCompatibility.AddBoolOption(0, _modEnabledConfig, GetProfileName(0));
                RiskOfOptionsCompatibility.AddBoolOption(0, _keepScrapperClosedConfig, GetProfileName(0));
                RiskOfOptionsCompatibility.AddDropdownOption(0, _profileOverrideConfig, GetProfileName(0));
                
                for (int i = 0; i < Utility.ALT_PROFILE_COUNT; i++)
                {
                    RiskOfOptionsCompatibility.AddStringOption(0, _profileNamesConfig[i], GetProfileName(0), true);
                }
            }
